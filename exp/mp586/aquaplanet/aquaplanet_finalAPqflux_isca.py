...
exp = Experiment('aquaplanet_finalAPqflux_isca', codebase=cb)



#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),os.path.join(GFDL_BASE,'exp/mp586/aquaplanet/input/ocean_qflux.nc')]
