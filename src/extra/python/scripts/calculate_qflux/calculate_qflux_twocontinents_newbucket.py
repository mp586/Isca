...
if __name__ == "__main__":
    ...
    input_dir=GFDL_BASE
    base_dir=GFDL_DATA
    land_file='input/two_continents/land.nc'
    base_exp_name='ISCA_HPC/two_continents_newbucket_fixedSSTs' # work directory
    exp_name='ISCA_HPC/two_continents_newbucket_fixedSSTs' # data directory 
    #ice_file_name=base_dir+'annual_mean_ice_albedo_change_test_mk2_4320_dt_rad_4/'+'run360/'+'atmos_monthly.nc'
    ice_file_name=None
    output_file_name=GFDL_BASE+'/input/two_continents/qflux_from_twocontinents_newbucket_fixedSSTs/ocean_qflux'

    start_file=240 # needs to be January month
    end_file=479 # needs to be December month 
    land_present=True
