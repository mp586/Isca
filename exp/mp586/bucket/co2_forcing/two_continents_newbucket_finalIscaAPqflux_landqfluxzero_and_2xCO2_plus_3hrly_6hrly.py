...
# for high temporal resolution data 
...
#Tell model which diagnostics to write
diag.add_field('dynamics', 'ps', time_avg=True)
diag.add_field('dynamics', 'bk', files=['atmos_6_hourly'])
diag.add_field('dynamics', 'pk', files=['atmos_6_hourly'])
...
diag.add_field('atmosphere', 'bucket_depth_cond', time_avg=True, files=['atmos_6_hourly'])
diag.add_field('atmosphere', 'bucket_depth_conv', time_avg=True, files=['atmos_6_hourly'])
diag.add_field('atmosphere', 'bucket_depth_lh', time_avg=True, files=['atmos_6_hourly'])
...
diag.add_field('dynamics', 'vor', time_avg=True, files=['atmos_6_hourly'])
diag.add_field('dynamics', 'div', time_avg=True, files=['atmos_6_hourly'])
...
diag.add_field('rrtm_radiation', 'toa_sw',time_avg=True, files=['atmos_6_hourly'])

diag.add_field('rrtm_radiation', 'flux_sw', time_avg=True, files=['atmos_6_hourly']) # net SW surface flux
diag.add_field('rrtm_radiation', 'flux_lw', time_avg=True, files=['atmos_6_hourly']) # net LW surface flux
...
diag.add_field('mixed_layer', 'flux_oceanq', time_avg=True, files=['atmos_6_hourly'])
...
# #Tell model which diagnostics to write
# diag.add_field('dynamics', 'ps', time_avg=True)
# diag.add_field('dynamics', 'bk', files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'pk', files=['atmos_3_hourly'])
# diag.add_field('atmosphere', 'precipitation', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('mixed_layer', 't_surf', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'sphum', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'ucomp', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'vcomp', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('mixed_layer', 'flux_lhe', time_avg=True, files=['atmos_3_hourly']) # latent heat flux (up) at surface
...
# #Tell model which diagnostics to write
# diag.add_field('dynamics', 'ps', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'bk', files=['atmos_3_hourly'])
# diag.add_field('dynamics', 'pk', files=['atmos_3_hourly'])
# diag.add_field('atmosphere', 'precipitation', time_avg=True, files=['atmos_3_hourly'])
# diag.add_field('mixed_layer', 't_surf', time_avg=True, files=['atmos_3_hourly'])
