...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='72260ba')
...
exp = Experiment('two_continents_T85res_topography_both_newbucket_finalIscaAPqflux_landqfluxzero_zerointegral', codebase=cb)
...
####### co2 experiment #######
exp = Experiment('two_continents_T85res_topography_both_newbucket_finalIscaAPqflux_landqfluxzero_zerointegral_2xCO2_spinup_361', codebase=cb)
