...
exp = Experiment('flat_continents_newbucket_fullnewbucketqflux', codebase=cb)
...
# create an Experiment object to handle the configuration of model parameters
# and output diagnostics
exp = Experiment('flat_continents_newbucket_fullnewbucketqflux_2xCO2_spinup361', codebase=cb)
...
# #Lets do a run!
exp.run(1, restart_file='/scratch/mp586/Isca_DATA/flat_continents_newbucket_fullnewbucketqflux/restarts/res0361.tar.gz', num_cores=NCORES)
for i in range(2,481):
    exp.run(i, num_cores=NCORES)
