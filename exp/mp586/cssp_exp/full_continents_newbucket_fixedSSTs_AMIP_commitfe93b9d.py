...
exp = Experiment('full_continents_newbucket_fixedSSTs_AMIP_commit'+commit_nr, codebase=cb)
...
#Lets do a run!
exp.run(241, restart_file=os.path.join(GFDL_DATA,'full_continents_newbucket_fixedSSTs_AMIP_commit'+commit_nr+'/restarts/res0240.tar.gz'), num_cores=NCORES)
