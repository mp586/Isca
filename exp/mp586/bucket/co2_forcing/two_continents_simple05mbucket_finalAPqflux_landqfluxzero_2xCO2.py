...
exp = Experiment('two_continents_simple05mbucket_finalAPqflux_landqfluxzero_2xCO2_spinup_349', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file='/scratch/mp586/Isca_DATA/two_continents_simple05mbucket_finalAPqflux_landqfluxzero/restarts/res0349.tar.gz', num_cores=NCORES)
