...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref02_plus_2pt52K_and_2xCO2_spinup_361_commit'+commit_nr, codebase=cb)
...
#        'max_bucket_depth_land':0.5, #Set max bucket depth over land default = 0.15
    ...
    'surface_flux_nml': {
        'veg_evap_prefactor': 0.2 # vegetation at 600 ppm co2 reduces evaporation by 80% -- just a suggestion 
    }
})
