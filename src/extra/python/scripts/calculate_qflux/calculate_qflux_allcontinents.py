...
if __name__ == "__main__":
    ...
    base_exp_name='full_continents_newbucket_fullnewbucketqflux_2xCO2_spinup361' # work directory
    exp_name='full_continents_newbucket_fullnewbucketqflux_2xCO2_spinup361' # data directory 
    #ice_file_name=base_dir+'annual_mean_ice_albedo_change_test_mk2_4320_dt_rad_4/'+'run360/'+'atmos_monthly.nc'
    ice_file_name=None
    output_file_name=GFDL_BASE+'/input/all_continents/full_continents_newbucket/ssts_from_co2_run/ocean_qflux'
