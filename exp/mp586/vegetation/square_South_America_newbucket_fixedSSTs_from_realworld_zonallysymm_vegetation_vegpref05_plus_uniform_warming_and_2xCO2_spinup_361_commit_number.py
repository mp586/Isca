...
exp = Experiment('square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1_commit_'+commit_nr, codebase=cb)
...
# # Do CO2 run with prescribed SSTS from Isca/square_South_America_newbucket_finalIscaAPqflux_landqfluxzero_zerointegral_with6hrly_2xCO2_spinup_361 starting from spun-up state of the run above

exp = Experiment('square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_361_commit_'+commit_nr, codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_commit_'+commit_nr+'/restarts/res0361.tar.gz'), num_cores=NCORES)
for i in range(2,481):
    exp.run(i, num_cores=NCORES)
