...
#cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='92d1c49') # using a commit doesn't work on ISCA, don't know why! This would be the original commit which was used in /scratch/mp586/Isca_DATA/ISCA_HPC/flat_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361/run0200/git_hash_used.txt"
...
# prescribed SSTs with climatology from Isca/flat_continents_newbucket_fullnewbucketqflux
exp = Experiment('flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref1', codebase=cb)
...
exp = Experiment('flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_realspinup361', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref1/restarts/res0361.tar.gz'), num_cores=NCORES)
