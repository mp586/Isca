...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_test', codebase=cb)
...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_test_plus_2pt52K_and_2xCO2_spinup_121', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_test/restarts/res0121.tar.gz'), num_cores=NCORES)
