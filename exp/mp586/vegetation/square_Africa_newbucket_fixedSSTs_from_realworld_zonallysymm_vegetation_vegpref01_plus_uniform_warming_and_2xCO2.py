...
exp = Experiment('square_Africa_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref01_plus_uniform_warming_and_2xCO2_spinup_121', codebase=cb)
