...
exp = Experiment('narrow_three_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref08_plus_uniform_warming_and_2xCO2_spinup_121', codebase=cb)
...
# just put this in here to see whether the veg_evap_prefactor thing is working at all, but set it to 1 so no veg effect
    'surface_flux_nml': {
        'veg_evap_prefactor': 0.8 # land evap = potential evap*0.7
    },
})


#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'narrow_three_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1/restarts/res0121.tar.gz'), num_cores=NCORES)
