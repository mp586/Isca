...
# Tell model how to write diagnostic


exp = Experiment('squareland_frierson_insolation_lepref0_0qflux_samealbedo_to_01land_samehcp_landocean_commit'+commit_nr, codebase=cb)
