...
exp = Experiment('squareland_noseasons_0qflux_landcp1_oceancp100_samealbedo_lepref0', codebase=cb)
...
#        'max_bucket_depth_land':0.5, #Set max bucket depth over land default = 0.15 
    ...
    'mixed_layer_nml': {
        ...
        'evaporation':True,    
        'depth':100., #Mixed layer depth
        'land_option':'input',    #Tell mixed layer to get land mask from input file
        'land_h_capacity_prefactor': 0.01, #What factor to multiply mixed-layer depth by over land. 
        'albedo_value': 0.25, #Ocean albedo value -- cloud covered ocean
        'land_albedo_prefactor' : 1.,
