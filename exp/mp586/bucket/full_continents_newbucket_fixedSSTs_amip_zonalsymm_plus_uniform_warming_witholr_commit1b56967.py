...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='1b56967') ##### the commit number I used for the test spinup run was 26a747a, 
## this one is from a new branch "new_bucket_26a747a", the only difference to 26a747a being that I copied over the file amip_zonsymm_uniform_warming.nc for the perturbed run, which didn't exist in  26a747a!
...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_witholr_commit1b56967', codebase=cb)
...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_witholr_commit1b56967', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'full_continents_newbucket_fixedSSTs_zonally_symmetric_wihtolr_commit1b56967/restarts/res0361.tar.gz'), num_cores=NCORES)
for i in range(2,481):
    exp.run(i, num_cores=NCORES)
