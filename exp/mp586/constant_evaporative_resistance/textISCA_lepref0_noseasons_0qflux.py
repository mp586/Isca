...
exp.inputfiles = [os.path.join(GFDL_BASE,'input/text_ISCA/land.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),os.path.join(GFDL_BASE,'input/squareland/ocean_qflux.nc')]
