...
# exp = Experiment('square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1', codebase=cb)
...
# #Lets do a run!
# # exp.run(122, restart_file=os.path.join(GFDL_DATA,'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1/restarts/res0121.tar.gz'), num_cores=NCORES)
...
exp = Experiment('square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1_plus_uniform_warming_and_2xCO2_spinup_361', codebase=cb)
...
# just put this in here to see whether the veg_evap_prefactor thing is working at all, but set it to 1 so no veg effect
    'surface_flux_nml': {
        'veg_evap_prefactor': 1. 
    },
})


#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1/restarts/res0361.tar.gz'), num_cores=NCORES)
