...
exp = Experiment('full_continents_simple1mbucket_qflux', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'init_bucket_depth_land':1, #Set initial bucket depth over land, default = 20, bucket is initially full 
        'max_bucket_depth_land':1, #Set max bucket depth over land default = 0.15 
