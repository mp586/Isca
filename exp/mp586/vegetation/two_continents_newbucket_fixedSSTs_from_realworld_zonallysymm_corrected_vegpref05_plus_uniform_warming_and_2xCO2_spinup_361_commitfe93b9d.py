...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_commit7bb4387/restarts/res0361.tar.gz'), num_cores=NCORES)
