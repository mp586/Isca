...
# Do CO2 run with prescribed SSTS from  + uniform warming of 2.52 K starting from spun-up state of the control fixed SST experiment (from Isca/full_continents_newbucket_fullnewbucketqflux)

#exp = Experiment('full_continents_newbucket_fixedSSTs_from_experiment_full_continents_newbucket_fullnewbucketqflux_plus_2pt52K_and_2xCO2_spinup_361', codebase=cb)
exp = Experiment('full_continents_newbucket_fixedSSTs_from_experiment_full_continents_newbucket_fullnewbucketqflux_plus_2pt52K_without_2xCO2_spinup_361', codebase=cb)

#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(GFDL_BASE,'input/all_continents/land.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),os.path.join(GFDL_BASE,'input/all_continents/prescribed_ssts_uniform.nc'), os.path.join(GFDL_BASE,'input/co2_doubling.nc')]
...
#        'max_bucket_depth_land':0.5, #Set max bucket depth over land default = 0.15
    ...
    'mixed_layer_nml': {
        ...
        'sst_file' : 'prescribed_ssts_uniform', #Set name of sst input file
