...
exp = Experiment('full_continents_newbucket_0qflux', codebase=cb)
...
# create an Experiment object to handle the configuration of model parameters
# and output diagnostics
exp = Experiment('full_continents_newbucket_0qflux_2xCO2_spinup361', codebase=cb)
...
exp.run(1, restart_file=os.path.join(GFDL_DATA,'full_continents_newbucket_0qflux/restarts/res0361.tar.gz'), num_cores=NCORES)
for i in range(2,481):
    exp.run(i, num_cores=NCORES)
