...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='8b6871c')
...
exp = Experiment('flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_spinup_361', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref1/restarts/res0121.tar.gz'), num_cores=NCORES)
