...
exp = Experiment('two_continents_flipped_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref05_plus_uniform_warming_and_2xCO2_spinup_361_commit'+commit_nr, codebase=cb)
