...
exp = Experiment('sqland_lepref07_finalAPqflux_landqfluxzero', codebase=cb)
...
####### co2 experiment #######
exp = Experiment('sqland_lepref07_finalAPqflux_landqfluxzero_2xCO2_spinup_361', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file='/scratch/mp586/Isca_DATA/sqland_lepref07_finalAPqflux_landqfluxzero/restarts/res0361.tar.gz', num_cores=NCORES)
