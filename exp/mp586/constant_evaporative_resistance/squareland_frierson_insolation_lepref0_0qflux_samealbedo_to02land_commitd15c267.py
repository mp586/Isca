...
exp = Experiment('squareland_frierson_insolation_lepref0_0qflux_samealbedo_to_02land_samehcp_landocean_commit'+commit_nr, codebase=cb)
...
#        'max_bucket_depth_land':0.5, #Set max bucket depth over land default = 0.15
    ...
    'mixed_layer_nml': {
        ...
        'land_albedo_prefactor' : 0.8, #What factor to multiply ocean albedo by over land
