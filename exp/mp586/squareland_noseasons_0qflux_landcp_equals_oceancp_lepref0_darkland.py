...
exp = Experiment('squareland_noseasons_0qflux_landcp_equals_oceancp9000000_samealbedo_lepref0_darkland', codebase=cb)
...
#        'max_bucket_depth_land':0.5, #Set max bucket depth over land default = 0.15 
    ...
    'mixed_layer_nml': {
        ...
        'albedo_value': 0.25, #Ocean albedo value -- cloud covered ocean
        'land_albedo_prefactor' : 0.1/0.25, #Land albedo = 0.1 (dark forest)
