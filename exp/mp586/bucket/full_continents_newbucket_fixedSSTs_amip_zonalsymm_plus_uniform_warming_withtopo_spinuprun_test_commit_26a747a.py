...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='26a747a') 
...
exp = Experiment('full_continents_newbucket_fixedSSTs_zonally_symmetric_testrun_commit26a747a', codebase=cb)
