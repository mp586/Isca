...
#cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='71bf652')
...
exp = Experiment('half_ocean_newbucket_0qflux_control', codebase=cb)
...
####### co2 experiment #######
exp = Experiment('half_ocean_newbucket_0qflux_4xCO2', codebase=cb)
