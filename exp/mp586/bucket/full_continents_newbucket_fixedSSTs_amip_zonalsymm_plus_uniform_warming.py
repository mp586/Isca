...
#Tell model how to write diagnostics
diag = DiagTable()
diag.add_file('atmos_15days', 16, 'days', time_units='days')
# diag.add_file('atmos_monthly', 30, 'days', time_units='days')
...
exp.namelist = namelist = Namelist({
    'main_nml': {
        'days'   : 16,  ### set to 15 for saving 15-day months output
        'hours'  : 0,
        'minutes': 0,
        'seconds': 0,
        'dt_atmos': 360, # default = 720
        'current_date' : [1,1,1,0,0,0],
        'calendar' : 'sixteen_day' ### set to fifteen_day for 15 day months output
    },
