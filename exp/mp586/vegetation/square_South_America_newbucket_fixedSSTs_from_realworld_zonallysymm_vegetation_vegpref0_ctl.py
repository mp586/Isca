...
exp = Experiment('square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_ctl', codebase=cb)
...
# just put this in here to see whether the veg_evap_prefactor thing is working at all, but set it to 1 so no veg effect
    'surface_flux_nml': {
        'veg_evap_prefactor': 0. # land evap = potential evap*0.7
    },
})
