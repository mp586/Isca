...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='58c14da')
...
exp = Experiment('full_continents_newbucket_fixedSSTs_from_experiment_full_continents_newbucket_fullnewbucketqflux', codebase=cb)

#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(GFDL_BASE,'input/all_continents/land.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),os.path.join(GFDL_BASE,'input/all_continents/prescribed_ssts_control.nc')]
