...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='a2d992c')
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'square_Africa_newbucket_finalIscaAPqflux_landqfluxzero/restarts/res0361.tar.gz'), num_cores=NCORES)
for i in range(2,481):
    exp.run(i, num_cores=NCORES)
