...
cb = IscaCodeBase.from_repo(repo='https://github.com/mp586/Isca.git', commit='')
...
exp = Experiment('two_continents_newbucket_fixedSSTs_from_0qflux_zonallysymm_EqMax', codebase=cb)

#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(GFDL_BASE,'input/two_continents/land.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),os.path.join(GFDL_BASE,'input/ssts_zonalsymm_EquatorMax.nc')]
...
exp.run(362, restart_file=os.path.join(GFDL_DATA,'two_continents_newbucket_fixedSSTs_from__zonallysymm/restarts/res0361.tar.gz'), num_cores=NCORES)
...
exp = Experiment('two_continents_newbucket_fixedSSTs_from_0qflux_zonallysymm_EqMax_plus_uniform_warming_and_2xCO2_spinup_361', codebase=cb)
...
exp.run(361, restart_file=os.path.join(GFDL_DATA,'two_continents_newbucket_fixedSSTs_from_0qflux_zonallysymm_EqMax/restarts/res0360.tar.gz'), num_cores=NCORES)
