...
exp = Experiment('square_Africa_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_ctl', codebase=cb)
...
exp = Experiment('square_Africa_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121_ctlvegpref05', codebase=cb)
...
#Lets do a run!
exp.run(1, restart_file=os.path.join(GFDL_DATA,'square_Africa_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_ctl/restarts/res0121.tar.gz'), num_cores=NCORES)
